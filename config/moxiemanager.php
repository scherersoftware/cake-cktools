<?php
/**
 * Default Moxie Manager Configuration. Options will be overridden by the
 * 'CkTools.moxiemanager' key in your App configuration.
 */


// General
$moxieManagerConfig['general.license'] = null;
...
// Authentication
$moxieManagerConfig['authenticator'] = ''; // disabled on purpose - we use the AuthComponent for this.
...
// Local filesystem
$moxieManagerConfig['filesystem.local.wwwroot'] = WWW_ROOT;
...
$moxieManagerConfig['log.path'] = LOGS;
...
$moxieManagerConfig['storage.path'] = TMP . 'moxiemanager/data/storage';
...
$moxieManagerConfig['basicauthenticator.users'] = [
    ["username" => "admin", "password" => "admin", "groups" => ["administrator"]]
];
...
return [
    'moxiemanager' => $moxieManagerConfig
];
